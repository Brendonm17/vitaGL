...
ifeq ($(DRAW_STATE_CACHE),1)
CFLAGS += -DDRAW_STATE_CACHE
endif

ifeq ($(DRAW_PHASE_PROFILING),1)
CFLAGS += -DDRAW_PHASE_PROFILING
endif

ifeq ($(UNIFORM_VALUE_CACHE),1)
CFLAGS += -DUNIFORM_VALUE_CACHE
endif
